class Loan < ApplicationRecord
  ...
  def schedule
    ...
    amount_paid = self.amount_paid.to_f
    tenor = self.campaign.tenor
    irr = self.campaign.irr.to_f
    origination_date = self.campaign.date.to_date
    grace_period = self.campaign.grace_period
